...
class Customer:
    ...
    def count_avg_month_price(self):
    ...
    def find_and_change_subscription_with_parameters(self, data: list):
        data_dict = {
            'Type': str,
            'Price': float,
            'Allowed clicks': int,
